        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="components/alert">
              <CAlert color="primary">A simple primary alertвЂ”check it out!</CAlert>
              <CAlert color="secondary">A simple secondary alertвЂ”check it out!</CAlert>
              <CAlert color="success">A simple success alertвЂ”check it out!</CAlert>
              <CAlert color="danger">A simple danger alertвЂ”check it out!</CAlert>
              <CAlert color="warning">A simple warning alertвЂ”check it out!</CAlert>
              <CAlert color="info">A simple info alertвЂ”check it out!</CAlert>
              <CAlert color="light">A simple light alertвЂ”check it out!</CAlert>
              <CAlert color="dark">A simple dark alertвЂ”check it out!</CAlert>
            </DocsExample>
          </CCardBody>
        </CCard>
      </CCol>
          ...
          <CCardBody>
            ...
            <DocsExample href="components/alert#dismissing">
              <CAlert
                ...
                dismissible
                onClose={() => {
                  alert('рџ‘‹ Well, hi there! Thanks for dismissing me.')
                }}
              >
