    ...
    <CRow>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              Skills Barter includes a bunch of predefined buttons components, each serving its own
              semantic purpose. Buttons show what action will happen when the user clicks or touches
              it. Skills Barter buttons are used to initialize operations, both in the background or
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              You can combine button with our <a href="https://coreui.io/icons/">icon library</a>.
            </p>
            <DocsExample href="components/buttons">
              {['normal', 'active', 'disabled'].map((state, index) => (
                <CRow className="align-items-center mb-3" key={index}>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <p className="text-body-secondary small">
              ...
              Skills Barter has to add <code>.disabled</code> className to make buttons look inactive.
              Skills Barter also has to add to the disabled button component{' '}
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              Create buttons that span the full width of a parentвЂ”by using utilities.
            </p>
