...
import ReactImg from 'src/template/assets/images/react.jpg'
    ...
    <CRow>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              in there. Shown below are image styles, blocks, text styles, and a list groupвЂ”all
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              You can instantly change the text arrangement of any cardвЂ”in its whole or specific
              partsвЂ”with{' '}
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              caps&#34;вЂ”images at the top or bottom of a card.
            </p>
