...
import AngularImg from 'src/template/assets/images/angular.jpg'
import ReactImg from 'src/template/assets/images/react.jpg'
import VueImg from 'src/template/assets/images/vue.jpg'
    ...
    <CRow>
      <CCol xs={12}>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">HereвЂ™s a carousel with slides</p>
