...
import { DocsLink } from 'src/template/components'
  ...
  return (
    <>
      ...
      <CCard className="mb-4">
        ...
        <div className="card-body">
          <p>
            ...
            вЂ”a larger, slightly more opinionated heading style.
          </p>
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p>
            Align terms and descriptions horizontally by using our grid systemвЂ™s predefined classes
