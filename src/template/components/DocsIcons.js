...
import IconsImg from 'src/template/assets/images/icons.webp'
  ...
  <div className="bg-warning bg-opacity-10 border border-2 border-warning rounded mb-4">
    <div className="row d-flex align-items-center p-3 px-xl-4 flex-xl-nowrap">
      <div className="col-xl-auto col-12 d-none d-xl-block p-0">
        <img className="img-fluid" src={IconsImg} width="160px" height="160px" alt="Skills Barter Icons" />
      </div>
      <div className="col-md col-12 px-lg-4">
        The icon package is delivered with more than 1500 icons in multiple formats SVG, PNG,
        and Webfonts. These icons are beautifully crafted symbols for common actions and items. You
